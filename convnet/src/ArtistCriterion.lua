local ArtistCriterion, parent = torch.class(
    'nn.ArtistCriterion',
    'nn.Criterion'
)

function ArtistCriterion:__init()
    parent.__init(self)
end

function ArtistCriterion:updateOutput(activ_origin, activ_gener)
...
function ArtistCriterion:updateGradInput(activ_origin, activ_gener)  
