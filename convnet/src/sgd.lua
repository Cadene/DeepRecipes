...
return function (opfunc, x, config, state)
   ...
   if lrs then
      ...
      --print(lrs:size())
      --print(dfdx:size())
      local last = lrs:size(1)
      print('lrs1', lrs[1], 'lrs_last', lrs[last])
      print('delta_before', state.deltaParameters[1], 'delta_last', state.deltaParameters[last])
      state.deltaParameters:copy(lrs):cmul(dfdx)
      print('delta_after', state.deltaParameters[1], 'delta_last', state.deltaParameters[last])
      print('x_before', x[1], 'x_last', x[last])
